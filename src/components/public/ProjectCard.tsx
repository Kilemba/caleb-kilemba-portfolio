...
import { ProjectVisual } from "@/components/public/ProjectVisual";
...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <article className="card overflow-hidden">
      {project.coverImage ? <img src={project.coverImage} alt={`${project.title} cover`} className="h-44 w-full object-cover" /> : <ProjectVisual slug={project.slug} />}
      <div className="p-6">
